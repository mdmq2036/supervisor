...
BEGIN
    ...
    IF admin_id IS NOT NULL THEN
        ...
        RAISE NOTICE 'Datos de prueba insertados para usuario admin (ID: %)', admin_id;
    ELSE
    ...
    IF prueba_id IS NOT NULL THEN
        ...
        RAISE NOTICE 'Datos de prueba insertados para usuario prueba (ID: %)', prueba_id;
    ELSE
...
BEGIN
    ...
    LOOP
        ...
        RAISE NOTICE 'Datos insertados para supervisor: % (ID: %)', supervisor_rec.usuario, supervisor_rec.id;
    END LOOP;
END $$;
